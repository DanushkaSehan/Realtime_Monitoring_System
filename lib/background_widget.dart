...
//   void paint(Canvas canvas, Size size) {
//     final Paint paint = Paint();
//     paint.color = const Color.fromARGB(255, 18, 19, 26);

//     const double waveHeight = 150;
//     final topPartHeight = size.height * 0.25;

//     final Path path = Path();
//     path.lineTo(size.width, 0);
//     path.lineTo(size.width, topPartHeight);
//     path.cubicTo(
//       size.width,
//       topPartHeight + waveHeight * 0.39,
//       size.width * 0.84,
//       topPartHeight + waveHeight * 0.86,
//       size.width / 2,
//       topPartHeight + waveHeight * 0.6,
//     );
//     path.cubicTo(
//       size.width * 0.16,
//       topPartHeight + waveHeight * 0.35,
//       size.width * 0.02,
//       topPartHeight + waveHeight * 0.85,
//       0,
//       topPartHeight + waveHeight,
//     );
//     path.lineTo(0, size.height);
